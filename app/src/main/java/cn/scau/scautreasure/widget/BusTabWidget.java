 ...
 * 内容是导航栏的（今天，明天和未来）
 */
@EViewGroup(R.layout.bus_tab)
public class BusTabWidget extends LinearLayout {
    ...
    public BusTabWidget(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void changeTab(int position) {
        ...
        float offset = (float) (getWidth() - getPaddingLeft() - getPaddingRight()) / 2;
